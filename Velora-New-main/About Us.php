...
<style>
    ...
    @media screen and (max-width: 768px) {
        .container {
            display: grid;
            /* position: absolute; */
            grid-template-columns: repeat(2, minmax(252px, 2fr));
            /* gap: 1rem; */
            max-width: 19rem;
            /* max-height: 22rem; */
            margin-left: 4rem;
    ...
    @media screen and (max-width: 550px) {
        .container {
            display: grid;
            /* position: absolute; */
            grid-template-columns: repeat(1, minmax(252px, 2fr));
            /* gap: 1rem; */
            max-width: 15rem;
            /* max-height: 22rem; */
            margin-left: 7rem;
    ...
    @media screen and (max-width: 768px) {
        .mission-grid {
            display: grid;
            grid-template-columns: repeat(1, minmax(292px, 2fr));
            /* gap: 15rem; */
            /* width: 100%; */
            margin-left: -8rem;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="image-card">
            <img class="image" src="./Assests/Images/leaf.png" alt="A hand holding a patient's arm">
        </div>

        <!-- Image 2 -->
        <div class="image-card">
            <img class="image" src="./Assests/Images/umb.png" alt="A hand holding a patient's arm">
        </div>

        <!-- Image 3 -->
        <div class="image-card">
            <img class="image" src="./Assests/Images/hand.png" alt="A hand holding a patient's arm">
        </div>

        <!-- Image 4 -->
        <div class="image-card">
            <img class="image" src="./Assests/Images/flower.png" alt="A hand holding a patient's arm">
        </div>
    </div>
